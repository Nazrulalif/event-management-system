...
<div class="container">
    ...
    @include('admin.event.add-agent-group')
    @include('admin.event.edit-agent-group')
...
<script>
    $(document).ready(function () {
        ...
        const checkProgress = () => {
            $.ajax({
                url: `/admin/events/${eventId}/check-progress-agent`,
                method: 'GET',
                dataType: 'json',
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#example').DataTable({
            ...
            autoWidth: false,
            responsive: true,
            ajax: `/admin/event-progress-agent-grouping/${eventId}`,
            columns: [
                {
                    data: 'nazir',
                    name: 'nazir'
        ...
        $('#example').on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/admin/event-progress-agent-grouping-delete/${id}`,
                        type: 'DELETE',
                        data: {
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                url: `/admin/event-progress-agent-grouping-show/${id}`, // Create a route to fetch group data
                type: 'GET',
                success: function (response) {
