...
<div class="container">
    ...
    @include('staff.event.edit-staff-group')
    @include('staff.event.add-staff-group')
...
<script>
    $(document).ready(function () {
        ...
        const checkProgress = () => {
            $.ajax({
                url: `/events/${eventId}/check-progress-staff`,
                method: 'GET',
                dataType: 'json',
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#example').DataTable({
            ...
            autoWidth: false,
            responsive: true,
            ajax: `/event-progress-staff-grouping/${eventId}`,
            columns: [{
                    data: 'group_name',
                    name: 'group_name'
                },
        ...
        $('#example').on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/event-progress-staff-grouping-delete/${id}`,
                        type: 'DELETE',
                        data: {
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                url: `/event-progress-staff-grouping-show/${id}`, // Create a route to fetch group data
                type: 'GET',
                success: function (response) {
