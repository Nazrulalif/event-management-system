            ...
            columns: [
                ...
                { data: 'created_at' },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div>
                                <a href="/agent/agent-detail/${row.id}" title="View" class="btn btn-primary btn-sm">
        ...
        $('#example').on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/agent/agent-management/delete/${userId}`,
                        type: 'DELETE',
                        data: {
