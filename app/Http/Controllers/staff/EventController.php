...
class EventController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('staff.event.all', compact('pendingCount'));
    }
    ...
    public function draft(Request $request)
    {
        ...
        $pendingCount = Event::where('status', 'Pending')->count();
        return view('staff.event.draft', compact('pendingCount'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.event.main', compact('data'));
    }
    ...
    public function schedule($id)
    {
        ...
        return view('staff.event.schedule', compact('data', 'existingSchedules', 'startDate', 'endDate'));
    }
    ...
    public function reward($id)
    {
        ...
        return view('staff.event.reward', compact(
            'data',
            'reward',
            'isComplete'
        ));
    ...
    public function target($id)
    {
        ...
        return view('staff.event.target', compact('data', 'products', 'targets'));
    }
    ...
    public function budget($id)
    {
        ...
        return view('staff.event.budget', compact('data', 'budget'));
    }
    ...
    public function staff($id, Request $request)
    {
        ...
        return view('staff.event.staff', compact(
            'data',
            'mentor',
            'leader',
            'member',
    ...
    public function agent($id, Request $request)
    {
        ...
        return view('staff.event.agent', compact(
            'data',
            'nazir',
            'member',
        ));
